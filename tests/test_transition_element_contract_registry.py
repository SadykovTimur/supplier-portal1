...
from tests.steps import open_contract_registry, transition_element_contract_registry
...
@allure.title('Переход по первому элементу реестра контрактов')
@allure.severity(allure.severity_level.BLOCKER)
@pytest.mark.parametrize('browser', CLIENT_BROWSERS)
@pytest.mark.parametrize('device_type', CLIENT_DEVICE_TYPE)
def test_transition_element_contract_registry(
