...
from tests.steps import open_registry_catalog, transition_element_registry_catalog
...
@allure.title('Переход по первому элементу реестра каталога')
@allure.severity(allure.severity_level.BLOCKER)
@pytest.mark.parametrize('browser', CLIENT_BROWSERS)
@pytest.mark.parametrize('device_type', CLIENT_DEVICE_TYPE)
def test_transition_element_registry_catalog(
