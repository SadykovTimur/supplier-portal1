def pytest_addoption(parser):
    group = parser.getgroup('supplier-portal')
    ...
    parser.addoption('--user', action='store', dest='username', type=str, default='pp_monitoring', help='Username')
    parser.addoption('--password', action='store', dest='password', type=str, default='RSYN6iIel', help='Password')
